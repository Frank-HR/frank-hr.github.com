    ...
    $.fn.KinSlideshow = function(settings) {
        ...
        function KinSlideshow_setTitleFont() {
            if (settings.isHasTitleFont) {
                $(KinSlideshow_BoxObjectSelector + " .KinSlideshow_titleBar").append("<h2 class='title' style='margin:6px 0 0 5px; float:left; padding:0;text-align:center;width:73%;'></h2>");
